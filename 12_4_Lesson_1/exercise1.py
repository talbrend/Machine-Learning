# -*- coding: utf-8 -*-
"""
Created on Tue May  1 22:05:41 2018
...
greeting = 'Hi '
name = 'Tal'  # enter your name in this string
...
print(len(my_long_sentence.split(' ')))
...
for person in students:
    print(person[0] + ' is ' + str(person[1]) + ' years old and likes ' + person[2])
...
for num in range(1,1001):
    ...
    listed_string_num = []
    for c in string_num:
        listed_string_num.append(c)
        for character in listed_string_num:
            sum += int(character)
